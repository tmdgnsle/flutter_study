import 'package:firebase_clean/page/register/provider/register_provider.dart';
import 'package:firebase_clean/page/register/provider/register_validator_provider.dart';
        ...
        child: Column(
          ...
          children: [
            ...
            FlatButton(
              ...
              onPressed: () {
                final dto = registerFormNotifier.getRegisterInfo();
