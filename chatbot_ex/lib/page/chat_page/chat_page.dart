...
import 'package:chatbot_ex/page/chat_page/widgets/chat_input.dart';
import 'package:chatbot_ex/page/chat_page/widgets/message_date_item.dart';
import 'package:chatbot_ex/page/chat_page/widgets/message_item.dart';
      ...
      BlocConsumer<ChatMessagesBloc, ChatMessagesState>(
        ...
        builder: (context, state) => Scaffold(
          ...
          body: CustomScrollView(
            ...
            slivers: _groupMessagesByDate(state.messages).entries.expand(
              (entry) {
