...
String _$familyHelloHash() => r'f289782b04a7136509660c5c1e4f4e58963f7e77';
...
class FamilyHelloFamily extends Family<String> {
  ...
  /// See also [familyHello].
  FamilyHelloProvider call({required String there}) {
    return FamilyHelloProvider(there: there);
  }
...
class FamilyHelloProvider extends Provider<String> {
  /// See also [familyHello].
  FamilyHelloProvider({required String there})
    : this._internal(
        (ref) => familyHello(ref as FamilyHelloRef, there: there),
        ...
        allTransitiveDependencies: FamilyHelloFamily._allTransitiveDependencies,
        there: there,
      );
  ...
  @override
  Override overrideWith(String Function(FamilyHelloRef provider) create) {
